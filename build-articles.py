...
<link rel="alternate" hreflang="ar" href="{SITE}/articles/{slug}">
<link rel="alternate" hreflang="en" href="{SITE}/en/articles/{slug}">
<link rel="alternate" hreflang="x-default" href="{SITE}/articles/{slug}">
...
<section class="works-band">
  <div class="wb-head">
    <div class="wb-eyebrow"><span data-ar>مشاريع أخرى</span><span data-en>Other projects</span></div>
    <div class="wb-title"><span data-ar>من تصميم الطيب عامر</span><span data-en>Designed by Altayeb Amer</span></div>
  </div>
  <div class="wb-panel wb-free">
    <h4 class="wb-h"><span data-ar>مشاريع مجانية</span><span data-en>Free projects</span></h4>
    <p class="wb-note"><span data-ar>كل مشروع صُمِّم ليكون مجانياً ونافعاً. شاركه مع من ينتفع به.</span><span data-en>Each project is built to be free and useful. Share it with someone who would benefit.</span></p>
    <div class="wb-grid">
      <a href="https://qurankarem.org" target="_blank" rel="noopener"><b>القرآن الكريم</b><span data-ar>مصحف رقمي</span><span data-en>Digital Quran</span></a>
      <a href="https://awraqna.com" target="_blank" rel="noopener"><b>أوراقنا</b><span data-ar>أوراق عمل للطباعة</span><span data-en>Printable worksheets</span></a>
      <a href="https://mawlidi.com" target="_blank" rel="noopener"><b>مَوْلِدي</b><span data-ar>الميلاد القمري</span><span data-en>Lunar birthdays</span></a>
    </div>
  </div>
  <div class="wb-sep" aria-hidden="true"></div>
  <div class="wb-panel wb-art">
    <h4 class="wb-h"><span data-ar>المعرض الفني</span><span data-en>Art gallery</span></h4>
    <div class="wb-grid">
      <a href="https://altayebamer.com" target="_blank" rel="noopener"><b>الفنان الطيب عامر</b><span data-ar>أعمال بصرية · دبي</span><span data-en>Visual art · Dubai</span></a>
    </div>
  </div>
</section>
<!-- works:end -->
...
/* فصل /en/: لا قلب داخل الصفحة — الزر ينتقل عبر assets/lang.js */
</script>
</body>
</html>
"""
